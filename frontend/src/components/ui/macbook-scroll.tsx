...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0,0.5, 1], [0, 850 ,850]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[.60] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img
          src="Screenshot 2024-12-27 012050.png"
          alt=""
